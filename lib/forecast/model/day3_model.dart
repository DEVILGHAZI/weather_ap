...
class Day3 {
  ...
  factory Day3.fromJson(Map<String, dynamic> json) {
    var dayJson = json['forecastday'][2]['day'];
    List<dynamic> hours = json['forecastday'][2]['hour'];
    ...
    return Day3(
      ...
      astro: json['forecastday'][2]['astro'] != null
          ? Astro.fromJson(json['forecastday'][2]['astro'])
          : null,
    );
  }
}
