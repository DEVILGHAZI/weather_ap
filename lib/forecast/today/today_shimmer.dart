...
class ShimmerEffectToday extends StatelessWidget {
  const ShimmerEffectToday({super.key});
  @override
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [box(context), box(context)],
                      ),
                    ),
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Please wait while we fetch today\'s weather...',
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 40.0, right: 10.0, top: 130.0),
            child: Align(
              alignment: Alignment.topLeft,
              child: Shimmer.fromColors(
                baseColor: Colors.grey[300]!,
